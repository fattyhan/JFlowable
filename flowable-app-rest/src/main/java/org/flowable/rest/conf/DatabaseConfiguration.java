...
public class DatabaseConfiguration {
    ...
    public DataSource dataSource() {
        ...
        String jdbcUrl = environment.getProperty("datasource.url", "jdbc:mysql://localhost:3306/jflow");
        String jdbcDriver = environment.getProperty("datasource.driver", "com.mysql.jdbc.Driver");
        String jdbcUsername = environment.getProperty("datasource.username", "jflow");
        String jdbcPassword = environment.getProperty("datasource.password", "360buy");
